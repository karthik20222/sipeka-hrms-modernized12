                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                            ...
                            >
                                <p className="font-medium text-center translate-y-[-60%] sm:translate-y-[-0%] sm:mb-2 md:text-left dark:text-white">
                                    SiPeKa (Employee Payroll System) is a system used by companies to manage the employee payroll process efficiently and accurately.
                                ...
                                <p className="font-medium text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left dark:text-white">
                                    In SiPeKa, employee information such as personal data, position, and salary level are stored centrally.
                                    Every month, the system will take employee attendance data and perform salary calculations based on the existing information.
